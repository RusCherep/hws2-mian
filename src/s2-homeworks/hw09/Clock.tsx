...
function Clock() {
    ...
    const formatterStringTime = new Intl.DateTimeFormat("ru", {
        hour12: false,
        hour: "numeric",
        minute: "numeric",
        second: "numeric"
    ...
    const stringTime = formatterStringTime.format(date) || <br/> // часы24:минуты:секунды (01:02:03)/(23:02:03)/(24:00:00)/(00:00:01) // пишут студенты
